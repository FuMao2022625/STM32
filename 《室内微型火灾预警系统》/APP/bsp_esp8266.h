...
// CH_PD 控制引脚 → PF4
#define      macESP8266_CH_PD_APBxClock_FUN                   RCC_APB2PeriphClockCmd
#define      macESP8266_CH_PD_CLK                             RCC_APB2Periph_GPIOF   // GPIOF 时钟
#define      macESP8266_CH_PD_PORT                            GPIOF
#define      macESP8266_CH_PD_PIN                             GPIO_Pin_4

// RST 控制引脚 → PF2
#define      macESP8266_RST_APBxClock_FUN                     RCC_APB2PeriphClockCmd
#define      macESP8266_RST_CLK                               RCC_APB2Periph_GPIOF
#define      macESP8266_RST_PORT                              GPIOF
